  ...
  <q-page padding>
    <q-card>
      ...
      <q-card style="width: 700px; max-width: 80vw;">
        ...
        />
        <q-input filled v-model="tanggalberangkat" label="Masukan tanggal keberangkatan *" lazy-rules
        :rules="[
          val => val !== null && val !== '' || 'Please type your tanggal keberangkatan']"
        />
    ...
    <q-dialog v-model="openedit" v-if="openedit">
      <q-card style="width: 700px; max-width: 80vw;">
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
          ...
          <q-input label="Tanggal Berangkat" v-model="activedata.tanggalberangkat"></q-input>
